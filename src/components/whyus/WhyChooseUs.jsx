...
function ImageStack({ images, ctaText, ctaHref }) {
  return (
    <div className="relative h-[520px] w-full sm:h-[580px] lg:h-[640px]">
      ...
      >
        <img src={images.secondary} alt="" className="h-full w-full object-cover" loading="lazy" />
        <div className="absolute inset-0 bg-gradient-to-bl from-novaderm-brown/20 to-transparent" />
      </motion.div>

      {/* ── Front main image (left, taller) ── */}
      <motion.div
      ...
      >
        <img src={images.tertiary} alt="" className="h-full w-full object-cover" loading="lazy" />
        <div className="absolute inset-0 bg-novaderm-brown/20" />
      </motion.div>

      {/* ── Floating rating pill ── */}
      <motion.div
        className="absolute right-4 top-[68%] z-10 flex items-center gap-2.5 rounded-full border border-novaderm-gold/30 bg-white px-4 py-2 shadow-lg"
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.93 }}
      >
        <span className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-novaderm-gold shadow-lg shadow-novaderm-gold/30 transition-all duration-300 group-hover:bg-novaderm-gold-dark">
...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why-us" className="relative overflow-hidden bg-[#f5efe8] py-20 lg:py-28">
