...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{
        position: "relative",
        // Clip the background layers that intentionally extend 8% below the
        // hero without creating the scroll container caused by overflow:hidden.
        // This prevents the desktop/laptop image from painting into the next
        // section while preserving mobile touch and slider behaviour.
        overflow: "clip",
        minHeight: "100svh",
        display: "flex",
        flexDirection: "column",
