          ...
          <>
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(90deg, transparent 0%, #C4614A 35%, #d4866a 55%, transparent 100%)" }}
              />
              ...
              <div className="flex items-center justify-end px-6 py-5">
                <motion.button
                  ...
                  whileHover={{ scale: 1.08, background: "#A0432E" }}
                  whileTap={{ scale: 0.92 }}
                >
              ...
              {/* Divider */}
              <div className="mx-6 h-px" style={{ background: "rgba(196,97,74,0.15)" }} />
                  ...
                  {links.map((link, i) => (
                    ...
                    >
                      <a
                        ...
                        style={
                          active === link.label
                            ? { background: "rgba(196,97,74,0.12)", color: "#C4614A", border: "1px solid rgba(196,97,74,0.30)" }
                            : { color: "rgba(61,46,36,0.65)", border: "1px solid transparent" }
                        }
                      >
                        <span style={{ letterSpacing: "0.03em" }}>{link.label}</span>
                        {link.hasDropdown
                          ? <ChevronDown className="h-3.5 w-3.5 opacity-40" />
                          : <ArrowUpRight className="h-3.5 w-3.5 opacity-25" />
                        }
                      </a>
                    </motion.li>
                  ))}
              ...
              <div className="px-5 pb-8 pt-2">
                <div className="mb-4 h-px" style={{ background: "rgba(196,97,74,0.15)" }} />
                ...
                <div className="mb-4 grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div
                      ...
                      style={{ background: "rgba(196,97,74,0.07)", border: "1px solid rgba(196,97,74,0.18)" }}
                    >
                      <span className="text-sm font-bold" style={{ color: "#C4614A" }}>{s.v}</span>
                      <span className="text-[9px] uppercase tracking-widest" style={{ color: "rgba(61,46,36,0.50)" }}>{s.l}</span>
                    </div>
                  ))}
                </div>
